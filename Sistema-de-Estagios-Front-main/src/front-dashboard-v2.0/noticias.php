        ...
        <div class="col-sm mb-2 mb-sm-0">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter">
              <li class="breadcrumb-item"><a class="breadcrumb-link" href="cursos.php">Cursos</a></li>
              <li class="breadcrumb-item"><a class="breadcrumb-link" href="empresas.php">Empresas</a></li>
              <li class="breadcrumb-item active" aria-current="page">Dicas</li>
            </ol>
          </nav>
          <h2 class="page-header-title">Nóticias</h2>
        </div>
      </div>
    </div>

    <?php
    $api = file_get_contents("https://newsapi.org/v2/everything?q=apple&from=2022-05-31&to=2022-05-31&sortBy=popularity&apiKey=bce250e04146430b847c90b11eec9fd4");
...
<div class="page-header">
  <div class="row align-items-center">
    <div class="col-sm">
      <h2 class="page-header-title">Nóticias</h2>
      <p class="page-header-text">Mercado de Financeiro</p>
    </div>
  </div>
