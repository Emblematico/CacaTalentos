          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account" aria-labelledby="accountNavbarDropdown" style="width: 16rem;">
                ...
                <a class="dropdown-item" href="home.php?logout">Sign out</a>
              </div>
            </div>
            <!-- End Account -->
          </li>
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                ...
                <div id="navbarVerticalMenuPagesUserProfileMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                  ...
                  <a class="nav-link " href="./vagasarea.php">Vagas Encontradas</a>
                </div>
              </div>
              <!-- End Collapse -->
              ...
              <div class="col-sm mb-2 mb-sm-0">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb breadcrumb-no-gutter">
                    <li class="breadcrumb-item"><a class="breadcrumb-link" href="resultados.html">Resultado</a></li>
                    <li class="breadcrumb-item"><a class="breadcrumb-link" href="curriculo.html">Currículo</a></li>
                    <li class="breadcrumb-item"><a class="breadcrumb-link" href="perfil.html">Perfil</a></li>
                  </ol>
                </nav>
                <h2 class="page-header-title">Currículo</h2>
              </div>
            </div>
          </div>
            ...
            <div id="addUserStepFormContent">
              ...
              <div id="addUserStepProfile" class="card card-lg active">
                ...
                <div class="card-body">
                  ...
                  <!-- End Form -->
                  <?php
    $aluno = (new Aluno())->get($_SESSION["aluno"]);
?>
                  <!-- Form -->
                  <form class="js-validate needs-validation" action="cadastro_curriculo.php" method="post">
                  <div class="row mb-4">
                    <label for="emailLabel" class="col-sm-3 col-form-label form-label">Nome Completo</label>

                    <div class="col-sm-9">
                      <input type="name" class="form-control" name="nome" id="nome" placeholder="Nome" aria-label="Nome" value="<?php echo $aluno["nome"]?>">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="email" class="form-control" name="email" id="email" placeholder="email@site.com" aria-label="clarice@site.com" value="<?php echo $aluno["email"]?>">
                    </div>
                  </div>
                  <!-- End Form -->
                  <?php
?>
                  ...
                  <div class="js-add-field row mb-4" data-hs-add-field-options='{
                    ...
                    <label for="phoneLabel" class="col-sm-3 col-form-label form-label">Telefone <span class="form-label-secondary">(Optional)</span></label>

                    <div class="col-sm-9">
                      <div class="input-group input-group-sm-vertical">
                        <input type="text" class="js-input-mask form-control" name="telefone" id="telefone" placeholder="(xx)xxxxx-xxxx" aria-label="+x(xxx)xxx-xx-xx" data-hs-mask-options='{
                                 "mask": "(00)00000-0000"
                               }'>
                        ...
                        <div class="tom-select-custom tom-select-custom-end">
                          <select class="js-select form-select" autocomplete="off" data-hs-tom-select-options='{
                            ...
                            <option value="Direct">Pessoal</option>
                          </select>
                        </div>
                        <!-- End Select -->
                      </div>
                  ...
                  "template": "#addPhoneFieldTemplate",
                   "container": "#addPhoneFieldContainer",
                    ...
                    <label for="phoneLabel" class="col-sm-3 col-form-label form-label">Celular <span class="form-label-secondary"></span></label>

                    <div class="col-sm-9">
                      <div class="input-group input-group-sm-vertical">
                        <input type="text" class="js-input-mask form-control" name="celular" id="celular" placeholder="(xx)xxxxx-xxxx" aria-label="+x(xxx)xxx-xx-xx" data-hs-mask-options='{
                                 "mask": "(00)00000-0000"
                               }'>
                  ...
                  <div id="addPhoneFieldTemplate" class="input-group-add-field" style="display: none;">
                    <div class="input-group input-group-sm-vertical align-items-center">
                      <input type="text" class="js-input-mask form-control" data-name="additionlPhone" placeholder="(xx)xxxxx-xxxx" aria-label="(xx)xxxxx-xxxx" data-hs-mask-options='{
                               "mask": "(00)00000-0000"
                             }'>
                  ...
                  <!-- Form -->
                  <div class="row mb-4">
                    <label for="organizationLabel" class="col-sm-3 col-form-label form-label">Organização</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="organizacao" id="organizacao" placeholder="Trabalho" aria-label="Htmlstream">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="departamento" id="departamento" placeholder="Departamento" aria-label="Human resources">
                    </div>
                  </div>

                  <div class="row mb-4">
                    <label for="departmentLabel" class="col-sm-3 col-form-label form-label">Formações</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="formacoes" id="formacoes" placeholder="Formações" aria-label="Formações">
                    </div>
                  </div>
                  <!-- End Form -->
                </div>
                ...
                <div class="card-footer d-flex justify-content-end align-items-center">
                  <button type="button" class="btn btn-primary" data-hs-step-form-next-options='{
                          ...
                          Próximo <i class="bi-chevron-right"></i>
                  </button>
                </div>
                <!-- End Footer -->
              </div>
              ...
              <div id="addUserStepBillingAddress" class="card card-lg" style="display: none;">
                ...
                <div class="card-body">
                  <!-- Form -->
                  <div class="row mb-4">
                    <label for="locationLabel" class="col-sm-3 col-form-label form-label">Estado</label>

                    <div class="col-sm-9">
                      <!-- Select -->
                      <div class="tom-select-custom mb-4">
                        <select class="js-select form-select" nome="estado"id="estado">
                      ...
                      <!-- End Select -->
                      <div class="mb-4">
                        <input type="text" class="form-control" name="cidade" id="cidade" placeholder="Cidade" aria-label="City">
                      </div>

                      <input type="text" class="form-control" name="bairro" id="bairro" placeholder="Bairro" aria-label="State">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <!-- Form -->
                  <div class="row mb-4">
                    <label for="addressLine1Label" class="col-sm-3 col-form-label form-label">Endereço</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="endereco" id="endereco" placeholder="Endereço" aria-label="Your address">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <!-- Form -->
                  <div class="row">
                    <label for="zipCodeLabel" class="col-sm-3 col-form-label form-label">Código postal <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="You can find your code in a postal address."></i></label>

                    <div class="col-sm-9">
                      <input type="text" class="js-input-mask form-control" name="codpostal" id="codpostal" placeholder="Código postal" aria-label="Your zip code" data-hs-mask-options='{
                               "mask": "AA0 0AA"
                             }'>
                    </div>
                  </div>
                ...
                <div class="card-footer d-flex align-items-center">
                  ...
                  <div class="ms-auto">
                    <button type="button" class="btn btn-primary" data-hs-step-form-next-options='{
                            ...
                            Salvar <i class="bi-chevron-right"></i>
                    </button>
                  </div>
                </div>
                </form>
              ...
              <div id="addUserStepConfirmation" class="card card-lg" style="display: none;">
                ...
                <div class="card-body">
                  <dl class="row">
                    ...
                    <dt class="col-sm-6 text-sm-end">Organização:</dt>
                    ...
                    <dt class="col-sm-6 text-sm-end">Cidade:</dt>
                    <dd class="col-sm-6">London</dd>

                    <dt class="col-sm-6 text-sm-end">Bairro:</dt>
                    <dd class="col-sm-6">-</dd>

                    <dt class="col-sm-6 text-sm-end">Endereço:</dt>
                    <dd class="col-sm-6">45 Roker Terrace, Latheronwheel</dd>

                    <dt class="col-sm-6 text-sm-end">Código postal:</dt>
                ...
                <div class="card-footer d-sm-flex align-items-sm-center">
                  ...
                  <div class="ms-auto">
                    <button type="button" class="btn btn-white me-2">Editar</button>
            ...
            <div id="successMessageContent" style="display:none;">
              <div class="text-center">
                ...
                <div class="mb-4">
                  <h2>Successful!</h2>
                  <p>New <span class="fw-semi-bold text-dark">Ella Lauda</span> user has been successfully created.</p>
                </div>
