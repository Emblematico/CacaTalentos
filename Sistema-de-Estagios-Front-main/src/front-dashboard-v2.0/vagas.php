...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
  ...
  <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
    <div class="navbar-nav-wrap">
      <!-- Logo -->
      <a class="navbar-brand" href="./home.php" aria-label="Front">
        ...
        <div class="dropdown ms-2">
          ...
          <div class="d-none d-lg-block">
            <div class="input-group input-group-merge input-group-borderless input-group-hover-light navbar-input-group">
              ...
              <input type="search" class="js-form-search form-control" placeholder="Pesquisar" aria-label="Pesquisar" data-hs-form-search-options='{
          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account" aria-labelledby="accountNavbarDropdown" style="width: 16rem;">
                ...
                <a class="dropdown-item" href="home.php?logout">Sair</a>
              </div>
            </div>
            <!-- End Account -->
          </li>
          ...
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div class="navbar-vertical-content">
              <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                ...
                <div id="navbarVerticalMenuPagesMenu">
                  ...
                  <div class="nav-item">
                    <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesUsersMenu" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuPagesUsersMenu" aria-expanded="false" aria-controls="navbarVerticalMenuPagesUsersMenu">
                      ...
                      <span class="nav-link-title">Usuário</span>
                    </a>
                    ...
                    <div id="navbarVerticalMenuPagesUsersMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                      ...
                      <a class="nav-link " href="./curriculo.php">Currículo</span></a>
                      <a class="nav-link " href="./resultados.php">Resultado</span></a>
                    </div>
                  </div>
                  <!-- End Collapse -->
                  ...
                  <div class="nav-item">
                    <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesUserProfileMenu" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuPagesUserProfileMenu" aria-expanded="false" aria-controls="navbarVerticalMenuPagesUserProfileMenu">
                      ...
                      <span class="nav-link-title">Vagas<span class="badge bg-primary rounded-pill ms-1">5</span></span>
                    </a>
    
                    <div id="navbarVerticalMenuPagesUserProfileMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                      <a class="nav-link " href="./vagas.php">Vagas Área</a>
                      <a class="nav-link " href="./vagasarea.php">Vagas encontradas na Área</a>
                    </div>
                  </div>
                  <!-- End Collapse -->
                  ...
                  <div class="nav-item">
                    <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesAccountMenu" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuPagesAccountMenu" aria-expanded="false" aria-controls="navbarVerticalMenuPagesAccountMenu">
                      ...
                      <span class="nav-link-title">Ver Notícias</span>
                    </a>
                ...
                <div class="nav-item">
                  <a class="nav-link " href="./acessibilidade.php" data-placement="left">
                    <i class="bi bi-badge-vo nav-icon"></i>
                    <span class="nav-link-title">Acessibilidade</span>
                  </a>
                </div>
        <!-- Footer -->
              ...
              <div class="dropdown dropup">
                ...
                <div class="dropdown-menu navbar-dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="selectThemeDropdown">
                  <a class="dropdown-item" href="#" data-icon="bi-moon-stars" data-value="auto">
                    ...
                    <span class="text-truncate" title="Auto (system default)">Automático (padrão do sistema)</span>
                  </a>
                  <a class="dropdown-item" href="#" data-icon="bi-brightness-high" data-value="default">
                    <i class="bi-brightness-high me-2"></i>
                    <span class="text-truncate" title="Default (light mode)">Padrão (modo de luz)</span>
                  </a>
                  <a class="dropdown-item active" href="#" data-icon="bi-moon" data-value="dark">
                    <i class="bi-moon me-2"></i>
                    <span class="text-truncate" title="Dark">Escuro</span>
                  </a>
                </div>
              </div>
            ...
            <li class="navbar-vertical-footer-list-item">
              ...
              <div class="dropdown dropup">
                ...
                <div class="dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="otherLinksDropdown">
                  <span class="dropdown-header">Ajuda</span>
                  <a class="dropdown-item" href="#">
                    <i class="bi-journals dropdown-item-icon"></i>
                    <span class="text-truncate" title="Resources &amp; tutorials">Recursos &amp; tutoriais</span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <i class="bi-command dropdown-item-icon"></i>
                    <span class="text-truncate" title="Keyboard shortcuts">Atalhos do teclado</span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <i class="bi-alt dropdown-item-icon"></i>
                    <span class="text-truncate" title="Connect other apps">Conecte outros aplicativos</span>
                  </a>
                  <a class="dropdown-item" href="#">
                    <i class="bi-gift dropdown-item-icon"></i>
                    <span class="text-truncate" title="What's new?">O que há de novo?</span>
                  </a>
                  <div class="dropdown-divider"></div>
                  <span class="dropdown-header">Contatos</span>
                  <a class="dropdown-item" href="#">
                    <i class="bi-chat-left-dots dropdown-item-icon"></i>
                    <span class="text-truncate" title="Contact support">Entre em contato com o suporte</span>
                  </a>
                </div>
              </div>
              <!-- End Other Links -->
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="vagasarea.html">Vagas Encontradas</a></li>
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="vagas.html">vagas</a></li>
              </ol>
            </nav>
            <h2 class="page-header-title">Vagas</h2>
          </div>
        </div>
      </div>
      <!-- End Page Header -->
      ...
      <div class="card-group">
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Comercial-Vendas.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Comercial, Vendas</h5>
            <p class="card-text">O departamento comercial pode ser definido como o setor responsável pelo relacionamento com os clientes. 
              Isso porque, muito além de apenas vender, este departamento atua desde a prospecção de clientes até o pós-venda, com o intuito de entender as necessidades dos consumidores e garantir satisfação.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="./comercial.php">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">122.185 vagas</small>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Informática-Telecomunicaçõe.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Informática, TI, Telecomunicaçõe</h5>
            <p class="card-text">Tecnologia da Informação (TI) é um conjunto de todas as atividades e soluções providas por recursos de computação que
              visam a produção, o armazenamento, a transmissão, o acesso, a segurança e o uso das informações.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="./informatica.php">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">45.973 vagas</small>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Telemarketing.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Telemarketing</h5>
            <p class="card-text">O telemarketing ou telemercadologia é o termo que designa a promoção de vendas e serviços por telefone.
              Com o tempo, passou a designar também serviços de cobrança e outros, como atendimento ao consumidor e suporte técnico por telefone.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="telemarketing.php">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">54.463 vagas</small>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/limentação-Gastronomia.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Alimentação / Gastronomia</h5>
            <p class="card-text">A gastronomia é um ramo de conhecimento que abrange a culinária, as bebidas, os materiais usados na alimentação e, em geral, todos os aspectos culturais a ela associados. </p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="gastronomia.php">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">25.973 vagas</small>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card-header">
      <div class="card-group">
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Logística.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Logística</h5>
            <p class="card-text">A logística é uma especialidade da administração e engenharia responsável por prover recursos e informações para a execução de todas as atividades de uma organização.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="#">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">15.453 vagas</small>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Administração.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Administração</h5>
            <p class="card-text">A Administração ou Gestão é a ciência social que estuda e sistematiza as práticas usadas para administrar. O termo "administração" significa direção, gerência.
              Ou seja, é o ato de administrar ou gerir negócios, pessoas ou recursos, com o objetivo de alcançar metas definidas.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="#">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">9.309 vagas</small>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Construção-Manutenção.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Construção, Manutenção</h5>
            <p class="card-text">Seu principal objetivo é reduzir e impedir falhas de máquinas e equipamentos que podem comprometer a segurança e saúde dos trabalhadores, assim como a produtividade na obra.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="#">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">89.185 vagas</small>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Recursos-Humanos.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Recursos Humanos</h5>
            <p class="card-text">Gestão de Recursos Humanos, Gestão de Pessoas ou Administração de Recursos Humanos é a aplicação de um conjunto de conhecimentos e técnicas administrativas especializadas no gerenciamento
              das relações das pessoas com as organizações, com o objetivo de atingir os objetivos organizacionais, bem como proporcionar a satisfação e a realização das pessoas envolvidas.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="#">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">27.973 vagas</small>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card-header">
      <div class="card-group">
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Serviços-Gerais.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Serviços Gerais</h5>
            <p class="card-text">Um serviço é um produto da atividade humana que satisfaz a uma necessidade, sem assumir a forma de um bem material.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="#">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">10.873 vagas</small>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Industrial-Produção-Fábrica.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Industrial, Produção, Fábrica</h5>
            <p class="card-text">Em economia e automação industrial, produção é um processo que consiste na combinação dos fatores de produção com a finalidade de satisfazer necessidades humanas, em termos de bens ou serviços.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="#">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">12.445 vagas</small>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Segurança.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Segurança</h5>
            <p class="card-text">A palavra segurança tem vários significados, a depender do ponto de vista. Em termos gerais, é o conjunto de medidas visando à proteção de riscos, perigos ou perdas a pessoas ou coisas. A segurança tem que ser comparada e contrastada com outros conceitos relacionados: Segurança, continuidade, confiabilidade.</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="#">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">48.273 vagas</small>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./assets/img/documentation/Contábil-Finanças-Economia.jpg" alt="Image Description">
          <div class="card-body">
            <h5 class="card-title">Contábil, Finanças, Economia</h5>
            <p class="card-text">É uma ciência aplicada que tem como objeto de estudo o patrimônio das entidades, seus fenômenos e variações, tanto no aspecto quantitativo quanto no qualitativo, registrando os fatos e atos de natureza econômico-financeira que o afetam e estudando suas consequências na dinâmica financeira</p>
          </div>
          <div class="card-footer">
          <a class="card-link" href="#">Mais empregos <i class="bi-chevron-right small ms-1"></i></a>
          </div>
          <div class="card-footer">
            <small class="text-muted">39.113 vagas</small>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-header">
        <div class="sliding-img">
          ...
          <div class="sliding-img-frame-to-start" style="background-image: url(./assets/img/others/img1.png);" data-hs-theme-appearance="dark"></div>
        </div>
      </div>
      <!-- Step -->
      <div class="card-header">
<ul class="step step-timeline-md">
  <li class="step-item">
    <div class="step-content-wrapper">
      ...
      <div class="step-content">
        <h4>Triagem de currículos</h4>
        <p class="step-text">Antes de falarmos sobre os estágios do processo seletivo, destacamos que é fundamental planejar algumas etapas do recrutamento, principalmente a descrição da vaga e a escolha dos canais de divulgação.</p>
      </div>
    </div>
  </li>
  ...
  <li class="step-item">
    <div class="step-content-wrapper">
      ...
      <div class="step-content">
        <h4>Contato com o candidato</h4>
        <p class="step-text">A próxima etapa do processo seletivo é o contato com os candidatos que tiveram o currículo pré-aprovado. Dois pontos são muito importantes nessa etapa. O primeiro é o nível de aceitação da vaga.</p>
      </div>
    </div>
  </li>
  ...
  <li class="step-item">
    <div class="step-content-wrapper">
      ...
      <div class="step-content">
        <h4>Teste de conhecimentos</h4>
        <p class="step-text">Os testes de conhecimento são necessários para conhecer os candidatos mais a fundo e garantir que eles tenham as competências e habilidades necessárias para o cumprimento das metas e objetivos da companhia.</p>
      </div>
    </div>
  </li>
  ...
  <li class="step-item">
    <div class="step-content-wrapper">
      ...
      <div class="step-content">
        <h4>Dinâmica de grupo</h4>
        <p class="step-text">Reza a cartilha das consultorias de RH que os candidatos que simulam uma determinada personalidade não costumam ir muito longe. As dinâmicas de grupo são excelentes formas de encurtar esse caminho.</p>
      </div>
    </div>
  </li>
  ...
  <li class="step-item">
    <div class="step-content-wrapper">
      ...
      <div class="step-content">
        <h4>Entrevista</h4>
        <p class="step-text">A lista das principais etapas do processo seletivo se encerra na entrevista, ponto no qual o contato com o candidato é mais estreito. O sucesso dessa fase também depende de planejamento — principalmente do roteiro.
          ...
          As entrevistas, inclusive, podem ser feitas por vídeo. Na atualidade, softwares de people analytics conseguem analisar o vídeo e elaborar relatórios com os principais termos utilizados e outros pontos identificados.</p>
      </div>
    </div>
  </li>
</ul>
...
<!-- End Step -->
    ...
    <div class="footer">
      <div class="row justify-content-between align-items-center">
        <div class="col">
          <p class="fs-6 mb-0">&copy; Caça Talentos. <span class="d-none d-sm-inline-block">Desenvolvido por Alex Lopes dos Santos Dias. Gabriel Lopes Ferreira Ramos. Igor Gustavo Alves Gonzalez. Lucas Lima Gomes. Rafaela Bezerra Martins. Thalya dos Santos Cuin &copy; 2022.</span></p>
        </div>
        <!-- End Col -->
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBuilder" aria-labelledby="offcanvasBuilderLabel">
    <div class="offcanvas-header align-items-start">
      <div>
        <h3 id="offcanvasBuilderLabel">Caça Talentos</h3>
        <p class="mb-0">Personalize o layout da página de visão geral.</p>
      </div>
      <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>

    <div class="offcanvas-body">
      <h4 class="mb-1">Modo de Aparência do Tema</h4>
      ...
      <div class="row gx-3">
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <span class="form-check-text">Predefinição</span>
          </div>
        </div>
        <!-- End Check -->
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <span class="form-check-text">Modo escuro</span>
          </div>
        </div>
        <!-- End Check -->
      </div>
      ...
      <div class="row gx-3">
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <span class="form-check-text">Escuro</span>
          </div>
        </div>
        <!-- End Check -->
      </div>
      ...
      <h4 class="mb-1">Barra de Navegação Lateral</h4>
      ...
      <div class="row gx-3">
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <span class="form-check-text">Comprimidos</span>
          </div>
        </div>
        <!-- End Check -->
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <span class="form-check-text">Abas</span>
          </div>
        </div>
        <!-- End Check -->
      </div>
      ...
      <label class="row form-check form-switch mb-3" for="builderFluidSwitch">
        <span class="col-10 ms-0">
          <span class="d-block h4 mb-1">Opções de layout de cabeçalho</span>
          <span class="d-block fs-5">Alternar para layout de fluido de contêiner</span>
        </span>
      ...
      <div class="row gx-3">
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <span class="form-check-text">Linha dupla</span>
          </div>
        </div>
        <!-- End Check -->
      </div>
        ...
        <div class="col">
          <div class="d-grid">
            <button type="button" id="js-builder-reset" class="btn btn-white btn-lg">
              <i class="bi-arrow-counterclockwise"></i> Redefinir
            </button>
          </div>
        </div>
        <!-- End Col -->
        ...
        <div class="col">
          <div class="d-grid">
            <button type="button" id="js-builder-preview" class="btn btn-primary btn-lg">
              <i class="eye-visible"></i> Visualizar
            </button>
          </div>
        </div>
        <!-- End Col -->
  ...
  <div id="builderOffcanvas" class="position-fixed bottom-0 end-0 me-5 mb-5" style="z-index: 3;" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBuilder" aria-controls="offcanvasBuilder">
    <a class="btn btn-dark btn-lg" href="javascript:;">
      <i class="bi-sliders fs-6 me-2"></i> Contraste
    </a>
  </div>
  <!-- End Builder Toggle -->
      ...
      <header id="header" class="navbar navbar-expand-lg navbar-bordered bg-white  ">
        <div class="container">
          <nav class="js-mega-menu navbar-nav-wrap">
            ...
            <a class="navbar-brand" href="./home.html" aria-label="Front">
              <img class="navbar-brand-logo" src="./assets/svg/logos/logo.svg" alt="Logo" data-hs-theme-appearance="default">
              <img class="navbar-brand-logo" src="./assets/svg/logos-light/logo.svg" alt="Logo" data-hs-theme-appearance="dark">
            </a>
