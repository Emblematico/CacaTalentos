    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col">
            <h1 class="page-header-title">Acessibilidade</h1>
          </div>
        </div>
        <!-- End Row -->
      </div>
          ...
          <div class="row">
            <div class="col-sm">
              ...
              <ul class="list-checked list-checked-primary">
                <li class="list-pointer-item">Este site foi desenvolvido para que pessoas com deficiência visual, baixa visão, daltonismo, deficiência auditiva e mobilidade reduzida possam navegar por meio de recursos como alto contraste, aumento de fonte, teclas de atalho, tradução para a Língua Brasileira de Sinais e navegação por teclado.
                  ...
                  Se for necessário, você também pode usar o zoom nativo do seu navegador, pressionando as teclas “Ctrl” e “+” para aumentar todo o site e “Ctrl” e “-“ para diminuir. Para voltar ao padrão, pressione “Ctrl” e “0”.</li>
                <li class="list-pointer-item">Botão de atalhos do teclado na barra inferior do site, localizada no lado direito da tela;</li>
              </ul>
              <!-- End List Checked -->
            </div>
      </div>
        ...
        <strong>
          <div class="row">
            <div class="col-sm">
              <!-- List Checked -->
              <ul class="list-checked list-checked-primary">
                <li class="list-pointer-item">Use a tecla Tab para navegar por elementos que recebem ação do usuário no site, tais como links, botões, campos de formulário e outros na ordem em que eles são apresentados na página, e Shift + Tab para retornar. Use as setas direcionais para acessar as informações textuais.
                  Sugestões de programas disponíveis para pessoas com deficiência:</li>
                <li class="list-pointer-item">Nitrous Voice Flux: controla o computador por voz. Gratuito;</li>
                <li class="list-pointer-item">NVDA: software livre para ler tela – vários idiomas (Windows);</li>
                <li class="list-pointer-item">YeoSoft Text: leitor de tela em inglês e português;</li>
                <li class="list-pointer-item">Jaws for Windows: leitor de tela – vários idiomas;</li>
                <li class="list-pointer-item">Virtual Vision: leitor de telas em português do Brasil;</li>
                <li class="list-pointer-item">DOSVOX: sistema para deficientes visuais (Windows ou Linux).</li>
                <li class="list-pointer-item">Talckback: leitor de tela disponível em smartphones Android.</li>
                <li class="list-pointer-item">Observação: leia no manual do leitor de telas sobre a melhor forma de navegação em páginas web.</li>
              </ul>
              <!-- End List Checked -->
            </div>
      </div>
        ...
        <strong>
          <div class="row">
            <div class="col-sm">
              <!-- List Checked -->
              <ul class="list-checked list-checked-primary">
                <li class="list-pointer-item">LIBRAS - Língua Brasileira de Sinais</li>
                <li class="list-pointer-item">Este site é acessível em LIBRAS através do VLibras.</li>
                <li class="list-pointer-item">Do lado direito de cada página do site existe o ícone de um Widget informando que o site é acessível em LIBRAS.</li>
                <li class="list-pointer-item">Para traduzir, basta clicar sobre o ícone e selecionar o texto que deseja traduzir.</li>
              </ul>
              <!-- End List Checked -->
            </div>
      </div>
