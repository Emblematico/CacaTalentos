...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
        ...
        <div class="col-sm mb-2 mb-sm-0">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-no-gutter">
              ...
              <li class="breadcrumb-item"><a class="breadcrumb-link" href="noticias.php">Dicas</a></li>
            </ol>
          </nav>
  ...
  <?php
    $api = file_get_contents("https://newsapi.org/v2/everything?q=companies&apiKey=bce250e04146430b847c90b11eec9fd4");
