          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="vagasarea.html">Vagas na área Encontradas</a></li>
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="vagas.html">vagas</a></li>
              </ol>
            </nav>
            <h2 class="page-header-title">Vagas na área Encontradas</h2>
          </div>
        </div>
      </div>
      <!-- End Page Header -->
