...
<head>
  ...
  <!-- Title -->
  <title>Informática, TI, Telecomunicaçõe</title>
      ...
      <div class="row align-items-center">
        <div class="col-sm mb-2 mb-sm-0">
          <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item"><a class="breadcrumb-link" href="vagasarea.php">Vagas Encontradas</a></li>
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="vagas.php">vagas</a></li>
            </ol>
          </nav>
          <h2 class="page-header-title">Informática, TI, Telecomunicaçõe</h2>
        </div>
      </div>
    </div>

    <?php
    $api = file_get_contents("https://newsapi.org/v2/everything?q=job&technology&from=2022-05-07&sortBy=publishedAt&apiKey=bce250e04146430b847c90b11eec9fd4");
    $NewsDate = json_decode($api, true);
    ?>

<?php
        foreach($NewsDate['articles'] as $News)
        {
            ?>
    <!-- Page Header -->
<div class="page-header">
  <div class="row align-items-center">
    <div class="col-sm">
      <h2 class="page-header-title">Comercial, Vendas</h2>
      <p class="page-header-text">Mercado de Trabalho</p>
    </div>
  </div>
  <div class="card-group">
    <div class="card">
      ...
      <a class="nav-link " href=<?php echo $News['url'] ?>>Mais Informações</a>
      </div>
      <div class="card-footer">
