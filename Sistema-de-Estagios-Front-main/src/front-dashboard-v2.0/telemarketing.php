    ...
    <div class="page-header">
      <div class="row align-items-center">
        <div class="col-sm mb-2 mb-sm-0">
          ...
          <h2 class="page-header-title">Telemarketing</h2>
        </div>
      </div>
    </div>

    <?php
    $api = file_get_contents("https://newsapi.org/v2/everything?q=jobs&telemarketing&from=2022-05-07&sortBy=publishedAt&apiKey=bce250e04146430b847c90b11eec9fd4");
